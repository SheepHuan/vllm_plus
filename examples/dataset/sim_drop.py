...
def load_cot_data(save_path,max_num=512):
    ...
    for item in dataset:   
        ...
        data.append(
            {
                "answer": answer,
                "target_doc": "\t You will be asked to read a passage and answer a question. passage:\n "+passage +" \n question:\n "+question+" Think step by step, then write a line of the form \"Answer: $ANSWER\" at the end of your response. \t",
                "candidate_doc": "\t You will be asked to read a passage and answer a question. passage:\n "+passage +" \n question:\n "+question+" Think step by step, then write a line of the form \"Answer: $ANSWER\" at the end of your response. \t",
            }
        )
