...
if __name__ == "__main__":
    ...
    benchmark_opus_epic= "examples/dataset/data/drop/drop_benchmark_epic.json"
    ...
    # benchmark_test.generate_full_compute(pipeline, benchmark_opus, benchmark_opus_full_compute,batch_size=32,max_tokens=512)
    ...
    #     cacheblend_recomp_ratio=0.40,enable_cacheblend_decode=False,max_tokens=512
    # ) 
    ...
    #     has_top_ratio=0.4,max_tokens=512
    # ) 
    ...
    benchmark_test.generate_with_epic(
        pipeline, benchmark_opus_with_kvcache, benchmark_opus_epic, kvcache_path,batch_size=16,
        enable_cacheblend_decode=True,
        cacheblend_recomp_ratio=0.40,max_tokens=512
    ) 
